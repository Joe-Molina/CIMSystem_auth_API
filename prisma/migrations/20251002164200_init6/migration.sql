...
INSERT INTO "new_first_contact_lote" ("accion", "contact", "contactAvailable", "contactCall", "contactCall_createdAt", "contact_createdAt", "createdAt", "id", "response", "responseCall", "responseCall_createdAt", "response_createdAt", "userId") SELECT "accion", "contact", "contactAvailable", "contactCall", "contactCall_createdAt", "contact_createdAt", "createdAt", "id", "response", "responseCall", "responseCall_createdAt", "response_createdAt", "userId" FROM "first_contact_lote";

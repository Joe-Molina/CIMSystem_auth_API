/*
  ...
  - You are about to drop the column `interactionTypeId` on the `interactions` table. All the data in the column will be lost.
  - Made the column `interaction_TypeId` on table `interactions` required. This step will fail if there are existing NULL values in that column.

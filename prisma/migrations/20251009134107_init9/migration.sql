...
CREATE TABLE "new_first_contact_lote" (
    ...
    "cuotasIniciales" INTEGER NOT NULL DEFAULT 100,
    CONSTRAINT "first_contact_lote_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Users" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_first_contact_lote" ("Payment", "PaymentId", "PromiseNonPayment", "PromisePayment", "accion", "caseStatus", "contact", "contactAvailable", "contactCall", "contactCall_createdAt", "contact_createdAt", "createdAt", "id", "note", "response", "responseCall", "responseCall_createdAt", "response_createdAt", "userId") SELECT "Payment", "PaymentId", "PromiseNonPayment", "PromisePayment", "accion", "caseStatus", "contact", "contactAvailable", "contactCall", "contactCall_createdAt", "contact_createdAt", "createdAt", "id", "note", "response", "responseCall", "responseCall_createdAt", "response_createdAt", "userId" FROM "first_contact_lote";

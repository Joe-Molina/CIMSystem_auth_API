...
INSERT INTO "new_first_contact_lote" ("accion", "contact", "contact_createdAt", "createdAt", "id", "response", "response_createdAt", "userId") SELECT "accion", "contact", "contact_createdAt", "createdAt", "id", "response", "response_createdAt", "userId" FROM "first_contact_lote";
